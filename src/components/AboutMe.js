...
const AboutMe = () => {
  return (
    <section className="my-services text-center">
      <h2
        className="text-3xl text-center mt-8 font-bold tracking-wide
      ...
      <div className="text-center text-neutral-50 px-8">
        <div className="mt-4">
          ...
          <p className="">
            ...
            concepts that make web designs stand out. My engineering background
            provides a strong analytical mindset to tackle any obstacle I came
            up with.
          </p>
        </div>
